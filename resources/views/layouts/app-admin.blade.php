...
<head>
    ...
    <link rel="canonical" href="https://keenthemes.com/metronic8" />
...
<body id="kt_body"
        ...
        <div class="d-flex flex-row flex-column-fluid page">
            ...
            <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                ...
                <div class="brand flex-column-auto" id="kt_brand">
                    <!--begin::Logo-->
                    <a href="https://bkppkutim.com/big-komputer-1357352886716187253/" class="brand-logo">
                        <img alt="Logo" src="assets/media/logos/logo4.png" style="height: 50px" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Toggle-->
                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                        ...
                        <ul class="menu-nav">
                            ...
                            @if (Auth::user()->user_level == 1)
                                ...
                                <li class="menu-section">
                                    <h4 class="menu-text">Manajemen Data</h4>
                                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                                </li>
                                ...
                                <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                    data-menu-toggle="hover">
                                    <a href="/cabang" class="menu-link menu-toggle">
                                        <span class="svg-icon menu-icon">
                                ...
                                <li class="menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="/suplier" class="menu-link menu-toggle">
                                        <span class="svg-icon menu-icon">
                                            <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                        ...
                                        <span class="menu-text">Manajemen Suplier</span>
                                    </a>
                                </li>
                                ...
                                <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                    data-menu-toggle="hover">
                                    <a href="/laporan" class="menu-link menu-toggle">
                                        <span class="svg-icon menu-icon">
    ...
    <div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
        ...
        <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
            <h3 class="font-weight-bold m-0">Big Computer Bengkulu
