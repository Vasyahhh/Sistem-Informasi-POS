    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            <div class="row g-5 g-xl-8">
                ...
                <div class="col-xl-4">
                    ...
                    <a href="" class="card bg-primary hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">Product</div>
                            <div class="fw-bold text-white">>></div>
                        </div>
                        <!--end::Body-->
                    </a>
                ...
                <div class="col-xl-4">
                    <!--begin::Statistics Widget 5-->
                    <a href="/laporan" class="card bg-success hoverable card-xl-stretch mb-5 mb-xl-8">
                        <!--begin::Body-->
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">Total Pendapatan</div>
                            <tr>
                                @foreach ($tot as $ab)
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">Rp.
