...
@section('content')
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group mb-1">
                                                                                ...
                                                                                <textarea
                                                                                    class="form-control" id="keterangan" name="keterangan" rows="3"> {{ $a->keterangan }}
                                                                                </textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
    ...
    <script>
        // Fungsi untuk menghitung ulang nilai profit
        function recalculateProfit() {
            var hrg_bli = $('#harga_beli').val().replace(/\D/g, ''); // Mengambil hanya angka dari input harga beli
            var hrg_jul = $('#harga_jual').val().replace(/\D/g, ''); // Mengambil hanya angka dari input harga jual
            var total = parseInt(hrg_jul) - parseInt(hrg_bli);
            // Fungsi number_format yang sama seperti yang Anda gunakan sebelumnya
            function number_format(number, decimals, dec_point, thousands_sep) {
                // ... (kode number_format yang sama seperti yang Anda gunakan sebelumnya)
            }
        }
    </script>
    ...
    <script>
        function
        sum() {
            var hrg_bli = $('#harga_beli').val().replace(/\D/g, '');
            var hrg_jul = $('#harga_jual').val().replace(/\D/g, '');
            var total = parseInt(hrg_jul) - parseInt(hrg_bli);
            $('#profit').val(total);
        }
    </script>
